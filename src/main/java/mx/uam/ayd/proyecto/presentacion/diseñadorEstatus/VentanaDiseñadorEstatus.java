...
public class VentanaDiseñadorEstatus extends JFrame {
	...
	public VentanaDiseñadorEstatus() {
		...
		lblDiseador_2.setBounds(10, 118, 256, 24);
		...
		btnNewButton.setBounds(366, 116, 117, 35);
		...
		lblDiseador_2_1.setBounds(10, 173, 256, 24);
		contentPane.add(lblDiseador_2_1);
		
		JLabel lblDiseador_2_2 = new JLabel("Actualizar pedido");
		lblDiseador_2_2.setForeground(Color.BLACK);
		lblDiseador_2_2.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblDiseador_2_2.setBounds(10, 221, 171, 24);
	...
	public void muestra(ControlDiseñadorEstatus control, int i){
		...
		lblFolio.setBounds(10, 83, 190, 24);
		...
		estatus_diseño.setBounds(276, 116, 80, 35);
		...
		estatus_Impresion.setBounds(276, 170, 80, 35);
		...
		btnActualizar.setBounds(191, 217, 117, 35);
